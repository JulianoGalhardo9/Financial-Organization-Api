    ...
    public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
    {
        ...
        public async Task<byte[]> Execute(DateOnly month)
        {
            ...
            foreach (var expense in expenses)
            {
                ...
                AddMountForExpense(row.Cells[3], expense.Amount);
        ...
        private Document CreateDocument(DateOnly month)
        {
            ...
            document.Info.Author = "Juliano Galhardo";
        ...
        private void CreateHeaderWithProfilePhotoAndName(Section page)
        {
            ...
            var row = table.AddRow();
            row.Cells[0].AddImage("/Users/julianogalhardo/Downloads/Foto.jpeg");

            row.Cells[1].AddParagraph("Olá, Juliano Galhardo");
        ...
        private void AddMountForExpense(Cell cell, decimal amount)
        {
            cell.AddParagraph($"-{amount:N2} {CURRENCY_SYMBOL}");
